...
var RoomIDGens *mgo.Collection
var UserIDGens *mgo.Collection
...
func InitMgo() {
	...
	RoomIDGens = Session.DB(dbName).C("col_room_id_gen")
	UserIDGens = Session.DB(dbName).C("col_user_id_gen")
